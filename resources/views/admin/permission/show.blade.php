            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <th>{{ $perm->name }}</th>
                  <th>{{ $perm->for }}</th>
                  <th><a href="{{ route('permission.edit',$perm->id) }}"><i class="glyphicon glyphicon-edit"></i></a></th>
                  <th>
                    <form id="delete-form-{{$perm->id}}" method="post" action="{{ route('permission.destroy',$perm->id) }}" style="display:none">
                    {{csrf_field()}}
                    {{method_field('delete')}}
                    </form>
                  <a href="" onclick="
